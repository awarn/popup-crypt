...
requirejs(['articles'], function(articles) {
  articles.someMethod('bla2');
  return articles.openArticle();
});
...
closeMenu = function() {
  ...
  return navdrawerContainer.classList.remove('open');
};
...
toggleMenu = function() {
  ...
  return navdrawerContainer.classList.add('opened');
};
